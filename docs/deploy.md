...
# 또는 scoop: scoop install turso
# 또는 직접 다운로드: https://github.com/tursodatabase/turso-cli/releases
...
## AI 평가 파싱 강화 추가 검증 (2026-03-11)

`src/lib/ai-evaluator.ts` JSON 파싱 강화 관련 항목:

- ✅ `npm run build` — ai-evaluator.ts 변경 후 빌드 성공, TypeScript 오류 없음
