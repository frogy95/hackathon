      ...
      <Card>
        <CardContent className="pt-6 text-left space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            ...
            <span className="text-zinc-500 font-medium">직군</span>
            <span className="col-span-2 text-zinc-900">{data.jobRole}</span>

            <span className="text-zinc-500 font-medium">조회 비밀번호</span>
            <span className="col-span-2 text-zinc-900">{data.checkPassword}</span>
